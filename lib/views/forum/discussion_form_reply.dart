        ...
        body: discussionTopicCommentsList == null
            ...
            : Column(
                children: [
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  "${widget.discussionTopicComments.discussionDetails!.memberName.toString()} | ${widget.discussionTopicComments.discussionDetails!.createDate.toString()}",
                  ...
                  if (discussionTopicCommentsList!.discussionComments!.isNotEmpty)
                    Expanded(
                              ...
                              child: Row(
                                ...
                                children: [
                                  if (discussionTopicCommentsList!
                                          .discussionComments![index].profileImage
                                          .toString() !=
                                      "")
                                    CachedNetworkImage(
                                      height: 36.h,
