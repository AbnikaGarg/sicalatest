...
class _SocialLinksPageState extends State<SocialLinksPage> {
  ...
  void submit() {
    ...
    service
        .addSocialLinks(facebookText.text, instaText.text, youtube.text,
            twiter.text, linkedin.text)
        .then((value) {
                ...
                children: [
                  ...
                  Expanded(
                    child: Padding(
                      ...
                      child: MyTextField(
                          textEditingController: facebookText,
                          hintText:
                ...
                children: [
                  ...
                  Expanded(
                    child: Padding(
                      ...
                      child: MyTextField(
                          textEditingController: instaText,
                          hintText:
